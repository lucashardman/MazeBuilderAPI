...
public class BreadthFirstSearch : ISolveStrategy
{
    public PathfindingAlgorithm PathfindingAlgorithmName => PathfindingAlgorithm.BreadthFirstSearch;
    ...
    public SolveResponse Solve(List<List<MazeVertex>> maze)
    {
        ...
        while (queue.Count > 0)
        {
            IntPoint current = queue.Dequeue();
            ...
            foreach (var (dx, dy) in directions)
            {
                ...
                // Marcar como visitada e adicionar à fila
